...
public sealed class IpcProviders : IDisposable, IApiService, IRequiredService
{
    ...
    public IpcProviders(IDalamudPluginInterface pi, IPenumbraApi api, CharacterUtility characterUtility)
    {
        ...
        [
            ...
            IpcSubscribers.TryGetModGroupPriority.Provider(pi, api.ModSettings),
            IpcSubscribers.TrySetModGroupPriority.Provider(pi, api.ModSettings),
            IpcSubscribers.NotifyTemporaryModSettingsChangedPlayer.Provider(pi, api.ModSettings),
